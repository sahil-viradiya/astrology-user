                                    ...
                                    child: ElevatedButton.icon(
                                      ...
                                      onPressed: () async {
                                        try {
                                          ...
                                          signupController.cEmail.text =
                                              emailid.toString();
                                          signupController.cName.text =
                                              username.toString();
                                          signupController.countryName =
                                              'India';
                                          log('signup emailid is $emailid');
                                          log('signup name is $username');
                                          log('countryName ${signupController.countryName}');
                                          signupController
